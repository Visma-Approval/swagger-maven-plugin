...
import com.github.kongchen.swagger.docgen.jaxrs.BeanParamExtension;
...
public class IncludedSwaggerExtensionTest {
    ...
    static {
        ...
        SWAGGER_EXTENSIONS.add(new BeanParamExtension(mock(JaxrsReader.class)));
    }
